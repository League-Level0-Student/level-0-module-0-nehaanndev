...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		...
		maze = ImageIO.read(getClass().getResource("ScaryMazeFileLEVEL0.png"));
	...
	private void scare() {
		...
		if (canPlaySounds) {
			...
			playScarySound("booingSound.wav");
		...
		showScaryImage("UpsetCrowad.jfif");
	}
